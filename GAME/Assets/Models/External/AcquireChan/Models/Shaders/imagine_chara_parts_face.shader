...
/*==========================================================================*/
/*!
	@file	imagine_chara_parts_face.shader
	@brief	イマジン専用シェーダー：キャラ描画特化（顔パーツ用）
	@author	By 
	@date 	2015/??/??
*/
/*==========================================================================*/
/*==========================================================================*/
Shader "Imagine/Character/Chara_Parts(Face)" 
{
	//==========================================================================//
	//		Properties 									         				//
	//==========================================================================//
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				float			_EyeClose;		// 目パチ：ブレンド割合
				sampler2D		_EyeTex;		// 目パチ：テクスチャ
				float4			_EyeTex_ST;		// 目パチ：テクスチャUV補正
...
//					o.SHLighting =  lerp ( ShadeSH9(float4(0,0,0,1)).rgb,ShadeSH9(float4(worldNormal,1)) * _LightProbeMultColor , _SHLightingDirection);
